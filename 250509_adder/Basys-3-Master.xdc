...
## Clock signal // clk 사용시 해제, FPGA에서 clk pin을 사용하기 위한 방법
...
#set_property -dict { PACKAGE_PIN W19   IOSTANDARD LVCMOS33 } [get_ports sel[0]]
#set_property -dict { PACKAGE_PIN T17   IOSTANDARD LVCMOS33 } [get_ports sei[1]]
